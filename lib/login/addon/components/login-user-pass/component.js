...
export default Component.extend({
  ...
  didInsertElement() {
    ...
    // 域名不是openkube.deepexi.cloud 需要验证
    const needValidate = window.location.host !== 'openkube.deepexi.cloud';

    set(this, 'needValidate', needValidate);
  ...
  actions: {
    authenticate() {
      ...
      const needValidate = get(this, 'needValidate');

      if (needValidate && !haveValidate) {
        alert('请先选择验证码');
